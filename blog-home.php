								...
								<div class="content relative">
								    ...
								    <a href="#" target="_blank">
								      ...
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Medicine</h4>
								        <span></span>								        
								        <p>All about medicines</p>
								      </div>
								    </a>
								</div>
							</div>
							...
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="#" target="_blank">
								      ...
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Technology</h4>
								        <span></span>								        
								        <p>Find what's new in the world of medicinal technology</p>
								      </div>
								    </a>
								</div>
							</div>
							...
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="#" target="_blank">
								      ...
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Lifestyle</h4>
								        <span></span>
								        <p>Articles to inspire healthy living and outlook</p>
								      </div>
								    </a>
								</div>
							</div>
