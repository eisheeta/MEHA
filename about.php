				...
				<div class="container-fluid">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 info-area-right">
							<h1>Who are we?</h1>
							<p>We are a group of three students from IGDTUW who are working towards simplifying the management of a patient's health records, reports and medical history and improve the efficiency and transparency during diagnosis.</p>
							<br>
							<p>
							Detailed medical records will be displayed in wiki-style format. Each provider adds to the common story rather than starting over with repeating elements. Thus saving money as well as time spent by an user.
							</p>
						</div>
					</div>
				</div>	
