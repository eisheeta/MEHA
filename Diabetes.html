	...
	<head>
		...
		<body>	
		  <header id="header">
			          ...
			          <li class="menu-has-children"><a href="">Features</a>
			            <ul>
					          ...
					          <li class="menu-has-children"><a href="">Know About Your Disease</a>
					            <ul>
					              <li><a href="https://symptomchecker.isabelhealthcare.com/suggest_diagnoses_advanced/landing_page">Symptom Checker</a></li>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								Treatment Chart For Type 2 Diabetes			
							</h1>	
			...
			<center><img src="img/diabetes.jpg" alt="" title="" ></center>
			</div>
